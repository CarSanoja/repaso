...
Chronological record by domain. Every entry is a dated, immutable document: corrections
are recorded as new entries, never by editing the past. Naming:
`YYYY-MM-DD-<domain>-NNN-<slug>.md` — domains: `plan`, `implementation`, `benchmark`,
`audit`, `product`.

| Date | Entry | Domain |
|---|---|---|
| 2026-08-20 | [Hackathon entry decision and plan](2026-08-20-plan-001-hackathon-entry.md) | Plan |
