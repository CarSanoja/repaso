...
Recommended category: **Everyday Agents**. The parent is the main user; the teacher is a possible beneficiary of a parent-forwarded note. The story is the routine that continues between requests and an adult decision with a visible consequence.
