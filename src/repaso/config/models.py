...
FALLBACK_MODELS: dict[ModelRole, tuple[str, ...]] = {
    ModelRole.GENERATE: ("us.anthropic.claude-haiku-4-5-20251001-v1:0",),
    ModelRole.JUDGE: ("us.anthropic.claude-haiku-4-5-20251001-v1:0",),
    ModelRole.STRUCTURED: ("us.amazon.nova-micro-v1:0",),
