from repaso.i18n.en_practice import PRACTICE
...
MESSAGES = {
    ...
    "consent": (
        ...
        "answers. What your child writes in their own words is deleted after 7 days; what "
        "stays is the attempt: that there was one, whether it was right, and when. "
        "/forget erases active data. Operational logs remain "
