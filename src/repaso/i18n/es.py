from repaso.i18n.es_practice import PRACTICE
...
MESSAGES = {
    ...
    "consent": (
        ...
        "respuestas de práctica. Lo que tu hijo o hija escribe con sus propias palabras se "
        "borra a los 7 días; queda el intento: si respondió, si estuvo bien y cuándo. "
        "/forget borra los datos activos. Los registros operativos "
