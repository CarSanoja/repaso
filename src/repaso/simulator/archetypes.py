...
PROFILES: dict[Archetype, ArchetypeProfile] = {
    Archetype.STEADY_MASTERY: ArchetypeProfile(
        archetype=Archetype.STEADY_MASTERY, base_ability=0.65, learning_rate=0.08,
    ...
    Archetype.DISENGAGED: ArchetypeProfile(
        archetype=Archetype.DISENGAGED, base_ability=0.7, learning_rate=0.05,
    ...
    Archetype.FORGETTING: ArchetypeProfile(
        ...
        forgetting_rate=0.15, response_rate=0.95, latency_mean=45.0, guess_probability=0.0,
    ),
    Archetype.AMBIGUOUS: ArchetypeProfile(
        archetype=Archetype.AMBIGUOUS, base_ability=0.72, learning_rate=0.05,
        forgetting_rate=0.05, response_rate=0.95, latency_mean=55.0, guess_probability=0.0,
    ),
    Archetype.INJECTOR: ArchetypeProfile(
        archetype=Archetype.INJECTOR, base_ability=0.65, learning_rate=0.05,
        forgetting_rate=0.05, response_rate=1.0, latency_mean=30.0, guess_probability=0.0,
    ),
}
